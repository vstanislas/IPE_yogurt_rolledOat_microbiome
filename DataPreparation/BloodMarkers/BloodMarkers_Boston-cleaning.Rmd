...
# 423    P-JH-423    423             KT       TNA 1811.190
data_S[c(82, 423),1:5]
#     Boston_S_ID ID_num Participant_ID Timepoint            zonulin
# 82      S-JH-82     82             KT       TNA 23.533999999999999
# 423    S-JH-423    423          ID114        T3 30.076000000000001   

### Kerstin do not replace the same blood samples in plasma and serum
### she replaces ID021_T2 for serum and ID114_T3 for plasma

which(data_P[,3] %in% c("KM", "KT")) #126 423
which(data_S[,3] %in% c("KM", "KT")) # 82 126
data_P[c(126, 423),1:5]
#     Boston_P_ID ID_num Participant_ID Timepoint    TNFR2
# 126    P-JH-126    126             KM       TNA 1831.436
# 423    P-JH-423    423             KT       TNA 1811.190
data_S[c(126, 82),1:5]
#     Boston_S_ID ID_num Participant_ID Timepoint            zonulin
# 126    S-JH-126    126             KM       TNA             24.273
# 82      S-JH-82     82             KT       TNA 23.533999999999999

################################################
# REMOVE UNCERTAIN SAMPLES + KM and KT samples #
################################################
