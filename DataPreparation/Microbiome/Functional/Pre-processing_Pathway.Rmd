...
```{r}
save(tse_pathway, physeq_pathway, file=paste(dir1, "Functional/TSE_Physeq_Pathway.Rdata", sep=""))
```
...
write.xlsx(desc_df_toSave, file=paste(dir, "DataAnalysis/Pathways_description.xlsx", sep=""), sheetName="Pathways description")
write.xlsx(desc_tax_df, file=paste(dir, "DataAnalysis/Pathways_description.xlsx", sep=""), sheetName="Pathways and taxonomy", append = T)
```
