...
path_analysis <- paste(dir, "DataAnalysis/Results_Main_Analysis/ResultsFunctional/On_KEGG/", sep="")
...
# Data preparation
```{r message=FALSE}
load(paste(dir, "DataPreparation/Microbiome/Functional/TSE_Physeq_KEGG.Rdata", sep=""))
...
### UNMAPPED explain probably all the variation on first axis
