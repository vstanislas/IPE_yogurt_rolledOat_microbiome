...
setwd(wd0)
run_taxa_model(taxa, package="NBZIMM", counts=F, FE=FE, RE=RE, DF=DF_work_mod, compar_var=compar_var, var_check=NULL, savingName=paste("NBZIMM_rel_asinsqrt_", compa, sep=""), sig_threshold=sig_threshold, check_mod=T, save_mod=F,  path=paste("NBZIMM_rel_asinsqrt/", compa, "/", sep=""))
toc()
