...
path_analysis <- paste(dir, "DataAnalysis/Results_Main_Analysis/ResultsFunctional/On_191601genes_fromCPM/", sep="")
...
# Data preparation
```{r message=FALSE}
load(paste(dir, "DataPreparation/Microbiome/Functional/TSE_Physeq_191601genes_fromCPM.Rdata", sep=""))
