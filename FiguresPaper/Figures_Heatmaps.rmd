...
```{r}
change_feature_name <- c("CRP", "Interleukin-6", "TNFR2", "Fructosamine", "RAGE", "8-OHdG", "Zonulin") 
...
See code to generate figure under /DataAnalysis/Results_Main_Analysis/genes_yogurtspecies.R
